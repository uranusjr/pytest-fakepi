# -*- coding: utf-8 -*-
#
# pytest-fakepi documentation build configuration file, created by
...
project = u'pytest-fakepi'
copyright = u'2015, Tzu-ping Chung'
author = u'Tzu-ping Chung'
...
man_pages = [
    (master_doc, 'pytest-cookiecutterplugin_name', u'pytest-fakepi Documentation',
     [author], 1)
]
